...
from models.Yolov3_730_2 import Yolov3, lossyolo
import torch.optim as optim
from utils.utils_730_2 import load_darknet_weights, intialization, freeze_darknet_backbone
...
def trainer():
    ...
    for epoch in range(num_epochs):
        ...
        for i, (image, label_sbbox, label_mbbox, label_lbbox, sbbox, mbbox, lbbox) in enumerate(dataloader):
            ...
            small_pre, middle_pre, large_pre = model(image, False)
